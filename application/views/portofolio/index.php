                            ...
                            <div class="testimonial same-height-always">
                                ...
                                <div class="bottom">
                                    ...
                                    <div class="name-picture">
                                        <img class="" alt="" src="<?php echo base_url();?>assests/img/person-1.jpg">
                                        <h5>John McIntyre</h5>
                                        <p>CEO, TransTech</p>
                                    </div>
                                </div>
                        ...
                        <li class="item">
                            <div class="testimonial same-height-always">
                                ...
                                <div class="bottom">
                                    ...
                                    <div class="name-picture">
                                        <img class="" alt="" src="<?php echo base_url();?>assests/img/person-2.jpg">
                                        <h5>John McIntyre</h5>
                                        <p>CEO, TransTech</p>
                                    </div>
                                </div>
                        ...
                        <li class="item">
                            <div class="testimonial same-height-always">
                                ...
                                <div class="bottom">
                                    ...
                                    <div class="name-picture">
                                        <img class="" alt="" src="<?php echo base_url();?>assests/img/person-3.jpg">
                                        <h5>John McIntyre</h5>
                                        <p>CEO, TransTech</p>
                                    </div>
                                </div>
                        ...
                        <li class="item">
                            <div class="testimonial same-height-always">
                                ...
                                <div class="bottom">
                                    ...
                                    <div class="name-picture">
                                        <img class="" alt="" src="<?php echo base_url();?>assests/img/person-4.jpg">
                                        <h5>John McIntyre</h5>
                                        <p>CEO, TransTech</p>
                                    </div>
                                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div id="references-masonry" data-animate="fadeInUp">
                        ...
                        <div class="reference-item" data-category="webdesign">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-1.jpg" class="img-responsive" alt="" />
                                ...
                                <div class="sr-only reference-description" data-images="<?php echo base_url();?>assests/img/main-slider1.jpg,<?php echo base_url();?>assests/img/main-slider2.jpg,<?php echo base_url();?>assests/img/main-slider3.jpg">
                        ...
                        <div class="reference-item" data-category="seo">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-2.jpg" class="img-responsive" alt="" />
                        ...
                        <div class="reference-item" data-category="marketing">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-3.jpg" class="img-responsive" alt="" />
                        ...
                        <div class="reference-item" data-category="marketing">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-4.jpg" class="img-responsive" alt="" />
                        ...
                        <div class="reference-item" data-category="webdesign">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-5.jpg" class="img-responsive" alt="" />
                        ...
                        <div class="reference-item" data-category="other">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-6.jpg" class="img-responsive" alt="" />
                        ...
                        <div class="reference-item" data-category="seo">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-7.jpg" class="img-responsive" alt="" />
                        ...
                        <div class="reference-item" data-category="webdesign">
                            <div class="reference">
                                <a href="#">
                                    <img src="<?php echo base_url();?>assests/img/portfolio-8.jpg" class="img-responsive" alt="" />
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-2  col-xs-6">
                            <div class="customer">
                                <img class="img-responsive" src="<?php echo base_url();?>assests/img/customers/kofola.png" title="Kofola" data-placement="bottom" data-toggle="tooltip" alt="">
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2  col-xs-6">
                            <div class="customer">
                                <img class="img-responsive" src="<?php echo base_url();?>assests/img/customers/evian.png" title="Evian" data-placement="bottom" data-toggle="tooltip" alt="">
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2  col-xs-6">
                            <div class="customer">
                                <img class="img-responsive" src="<?php echo base_url();?>assests/img/customers/cslink.png" title="CS Link" data-placement="bottom" data-toggle="tooltip" alt="">
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2  col-xs-6">
                            <div class="customer">
                                <img class="img-responsive" src="<?php echo base_url();?>assests/img/customers/botas66.png" title="Botas 66 Concept store" data-placement="bottom" data-toggle="tooltip" alt="">
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2  col-xs-6">
                            <div class="customer">
                                <img class="img-responsive" src="<?php echo base_url();?>assests/img/customers/mdfc.png" title="MediaFabríca" data-placement="bottom" data-toggle="tooltip" alt="">
                            </div>
                        </div>

                        <div class="col-sm-4 col-md-2  col-xs-6">
                            <div class="customer">
                                <img class="img-responsive" src="<?php echo base_url();?>assests/img/customers/vanek.png" title="VANĚK Strojírenská výroba" data-placement="bottom" data-toggle="tooltip" alt="">
                            </div>
                        </div>
...
_________________________________________________________ -->
        ...
        <div class="section" id="footer">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <p class="template-bootstrapious">Template by <a href="https://bootstrapious.com/free-templates">Bootstrapious</a></p>
    ...
    <!-- js base -->
    <script src="<?php echo base_url();?>assests/js/jquery-1.11.0.min.js"></script>
    <script src="<?php echo base_url();?>assests/js/bootstrap.min.js"></script>

    <!-- for demo purpose -->
    <script src="<?php echo base_url();?>assests/js/jquery.cookie.js"></script>
    ...
    <script src="<?php echo base_url();?>assests/js/gmaps.js"></script>

    <!-- masonry layout -->
    <script src="<?php echo base_url();?>assests/js/masonry.pkgd.min.js"></script>
    ...
    <!-- jQuery parallax -->
    <script src="<?php echo base_url();?>assests/js/jquery.parallax-1.1.3.js"></script>
